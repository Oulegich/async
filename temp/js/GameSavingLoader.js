...
var GameSavingLoader = exports["default"] = /*#__PURE__*/function () {
  function GameSavingLoader() {
    _classCallCheck(this, GameSavingLoader);
  }
  _createClass(GameSavingLoader, null, [{
    key: "load",
    value: function load() {
      return new Promise(function (resolve, reject) {
        (0, _reader["default"])().then(function (data) {
          return (0, _parser["default"])(data);
